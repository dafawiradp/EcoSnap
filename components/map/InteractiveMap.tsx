...
>>>>>>> f18124637490e94e2ac76f86ed80e3978d52a0e6
...
=======
    ...
    // SECTION E: Improved keyboard handler with input focus check
    useEffect(() => {
        const handler = (e: KeyboardEvent) => {
...
>>>>>>> f18124637490e94e2ac76f86ed80e3978d52a0e6
    ...
    // SECTION H: RAF loop - gate with environment flag for debug only
    const [fps, setFPS] = useState(60);
        ...
        <MapCoreContext.Provider value={coreContextValue}>
            <MapStateContext.Provider value={stateContextValue}>
                <div className="relative h-full w-full overflow-hidden rounded-xl">
                    ...
                    {loading && (
                        <div className="absolute top-24 left-5 z-[999]">
                    ...
                    {/* Bounds info panel */}
                    <div className="absolute bottom-5 left-5 z-[999]">
                    ...
                    {process.env.NODE_ENV === 'development' && (
                        <div className="absolute right-5 top-48 z-[999]">
                    ...
                    {/* Brand label */}
                    <div className="absolute bottom-28 left-5 z-[999]">
                    ...
                    <div className="absolute bottom-5 right-5 sm:right-14 md:right-56 z-[999]">
